...
class TestRosenfeldTaranzonaPoly(BaseTestThermalMod):
    ...
    def init_params(self,eos_d):
        ...
        # V0 = V0_ccperg*mass*eos_d['const_d']['ang3percc']/eos_d['const_d']['Nmol']
    ...
    #     param_d = eos_d['param_d']
    #     Vgrid_a = np.linspace(0.7,1.2,Nsamp)*param_d['V0']
    #     Tgrid_a = np.array([2500,3000,3500,4000,4500,5000])
    ...
    #         # ienergy_a = thermal_mod.energy(Vgrid_a,iT,eos_d)
    #         # ipress_a = thermal_mod.press(Vgrid_a,iT,eos_d)
    #         # energy_mod_a.append(ienergy_a)
    ...
    #     from IPython import embed; embed(); import ipdb; ipdb.set_trace()
    #     plt.plot(Vgrid_a,heat_capacity_mod_a.T,'-')
